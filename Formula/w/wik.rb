class Wik < Formula
  ...
  desc "View Wikipedia pages from your terminal"
  ...
  test do
    assert_match "Homebrew is a free and open-source software package management system",
      shell_output("#{bin}/wik --info 'Homebrew (package manager)'")
  end
end
